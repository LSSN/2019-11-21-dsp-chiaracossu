...
```
Faust è un linguaggio di programmazione,testuale (si scrive un testo che viene interpretato)funzionale(ha un solo scopo), ovvero si usa per srivere programmi audio 
